...
const PrivacyPolicy = () => {
  return (
    <div style={{ margin: "5%" }}>
      ...
      <ul style={{ paddingLeft: "40px !important" }}>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Azarkian Architetcure P.C., 130 w 37th st
            ground floor.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Usage Data</strong> refers to data collected 40pxmatically,
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Azarkain Architecture P.C.,
            accessible from{" "}
            <a
              href="https://www.aapc.nyc"
      ...
      <h4>Usage Data</h4>
      <p>Usage Data is collected 40pxmatically when using the Service.</p>
      <p>
      ...
      <p>
        ...
        collect certain information 40pxmatically, including, but not limited
