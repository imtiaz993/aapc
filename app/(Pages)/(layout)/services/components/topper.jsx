    ...
    <div style={{ position: "relative", height: "90vh" }}>
      ...
      <div className="top-wrapper">
        ...
        <h3 id="planning-top" className="topper-blurb">
          ...
          schematic design to the creation of detailed construction drawings and
          specifications, architectural planning is a dynamic process that
          integrates creativity, functionality, and compliance.{" "}
        </h3>
        <h3 id="visualization-top" className="topper-blurb">
          Architectural visualization services are an integral aspect of modern
          design, employing advanced technology to create immersive and
          ...
          stakeholders but also allows for informed decision-making by providing
          a vivid preview of the final built environment.{" "}
        </h3>
        <h3 id="project-management-top" className="topper-blurb">
          ...
          project timelines, budgets, and resources while maintaining effective
          communication among clients, architects, contractors, and regulatory
          authorities. Our expertise lies in navigating challenges, mitigating
          risks, and optimizing efficiency to deliver successful architectural
          projects that align with client expectations and industry best
          practices.
        </h3>
      </div>
    </div>
