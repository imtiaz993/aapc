    ...
    <div className="flex-container">
      ...
      <div className="flex-item-right">
        ...
        <h3 className="about-text">
          ...
          only adhere to regulations but also navigate them with precision when
          intervening in established spaces. Our dynamic team stands out in
          addressing client challenges through innovative solutions, ensuring
          unwavering compliance with all codes and regulations mandated in New
          York City. Our pride in our craft is substantiated by years of
          experience and thorough code research, underpinning every decision we
          make.
        </h3>
        <br />
        <br />
